...
export class UpdateForeignKeysTopic1560107757564 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "topic" ALTER COLUMN "user_id" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "topic" ALTER COLUMN "user_id" DROP NOT NULL`);
